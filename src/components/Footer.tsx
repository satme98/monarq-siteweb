  ...
  return (
    <footer className="bg-monarq-black text-white relative overflow-hidden pt-24 pb-20 border-t border-monarq-gold/30">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        {/* 4-Column Grid with Spacious Proportions & No Cramped Dividers */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-10 xl:gap-14 pb-20 border-b border-white/10">
          ...
          <div className="space-y-6 lg:col-span-4 lg:pr-6">
            ...
            <div className="flex items-center gap-3.5 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/20 flex items-center justify-center text-gray-200 hover:text-monarq-gold hover:border-monarq-gold transition-all duration-300 group"
          ...
          {/* Column 2: Horaires d'Ouverture (Span 3) */}
          ...
          {/* Column 3: Localisation & Accès (Span 3) */}
          <div className="space-y-5 lg:col-span-3">
            <div className="flex items-center gap-2.5 mb-5">
          ...
          {/* Column 4: Réservation Rapide (Span 2) */}
          <div className="space-y-5 lg:col-span-2 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2.5 mb-5">
            ...
            <button
              ...
              className="w-full py-3.5 px-5 rounded-full btn-gold text-xs uppercase tracking-[0.2em] font-semibold shadow-luxury text-center hover:scale-[1.02] transition-transform"
            >
        ...
        <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-gray-400 font-medium">
          ...
          <div className="flex items-center gap-8">
            <button 
              ...
              className="hover:text-monarq-gold transition-colors uppercase tracking-[0.18em] font-medium"
            >
              La Carte
            </button>
            <button 
