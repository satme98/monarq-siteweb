...
export const signatureHighlights = [
  {
    ...
    description: "Brioche aux crevettes, avocat, mangue et sauce piquante, omelette, galette de pommes de terre, fromage emmental, yaourt maison et pain perdu.",
    image: '/images/dish-monarq-prestige.jpg',
  },
  {
    name: 'Un Dimanche à Paris',
    category: 'BRUNCHS COMPLETS',
    description: 'Brioche façon pain perdu, bacon de bœuf fumé, œufs brouillés et poêlée de champignons parfumée à la truffe, duo de mini-pancakes et yaourt maison.',
    image: '/images/dish-dimanche-paris.jpg',
  },
  {
    name: 'Monarq Crevettes',
    category: 'PÂTES ARTISANALES',
    description: 'Penne aux crevettes sautées, sauce piquante signature de notre chef mijotée aux herbes fraîches et parmesan affiné.',
    image: '/images/dish-monarq-crevettes.jpg',
  },
  {
    name: 'Pizza Burrata',
    category: 'PIZZAS AU FEU DE BOIS',
    description: 'Sauce tomate artisanale, mozzarella fior di latte, cœur de burrata entière crémeuse, tomates cerises confites et basilic frais.',
    image: '/images/dish-pizza-burrata.jpg',
  },
  {
    name: 'Filet Pur Black Angus',
    category: "VIANDES D'EXCEPTION",
    description: 'Pièce noble de bœuf Black Angus grillée à la flamme à la perfection, servie avec accompagnement au choix et réduction parfumée.',
    image: '/images/dish-black-angus.jpg',
  },
  {
    name: 'Bagel au Saumon Fumé',
    category: 'BRUNCHS COMPLETS',
    description: "Bagel toasté, fromage frais, mousse d'avocat, saumon fumé noble et roquette, accompagné d'un pancake doré et yaourt maison.",
    image: '/images/dish-bagel-saumon.jpg',
  },
  {
    name: 'Monarq Poulet',
    category: 'PÂTES ARTISANALES',
    description: 'Penne au poulet émincé doré, sauce piquante signature, crème onctueuse et parmesan affiné.',
    image: '/images/dish-monarq-poulet.jpg',
  },
  {
    name: 'Salade Burrata Gourmande',
    category: 'SALADES RAFFINÉES',
    description: "Burrata crémeuse, roquette sauvage, tomates cerises, tranches de pêche, raisin, segments d'orange et réduction balsamique.",
    image: '/images/dish-burrata-gourmande.jpg',
  },
  {
    name: 'Risotto au Saumon & Pesto',
    category: 'RISOTTOS ONCTUEUX',
    description: 'Riz Carnaroli crémeux, pavé de saumon rôti, épinards frais et pesto vert au basilic et parmesan.',
    image: '/images/dish-risotto-saumon.jpg',
  },
  {
    name: 'Tartine à la Stracciatella',
    category: 'TARTINES GOURMANDES',
    description: 'Tartine aux céréales, fromage blanc, bacon de bœuf, pêche caramélisée, stracciatella crémeuse, basilic et roquette.',
    image: '/images/dish-tartine-stracciatella.jpg',
  },
  {
    name: 'Pizza Carnivore',
    category: 'PIZZAS AU FEU DE BOIS',
    description: 'Sauce tomate, mozzarella, pepperoni, jambon de dinde, poulet émincé, viande hachée assaisonnée et sauce barbecue.',
    image: '/images/dish-pizza-carnivore.jpg',
  },
  {
    name: 'Tajine de Viande aux Pruneaux',
    category: 'PLATS DU ROYAUME',
    description: "Bœuf tendre mijoté aux épices douces, pruneaux confits au caramel d'or et amandes effilées torréfiées.",
